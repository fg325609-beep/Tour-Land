        ...
        <div className="space-y-16">
          {factsData.map((item) => (
            ...
            >
              <div className="flex flex-col md:flex-row items-start gap-8 lg:gap-12">
                ...
                <div className="w-full md:w-5/12 flex-shrink-0">
                  <img 
                    ...
                    onError={(e) => {
                      // Rasm yuklanmay qolsa zaxira panda rasmini ochadi
                      e.currentTarget.src = "https://images.unsplash.com/photo-1564349683136-77e08dba1ef9?q=80&w=800&auto=format&fit=crop";
                    }}
                  />
                </div>
                ...
                <div className="w-full md:w-7/12 flex flex-col justify-between">
                  <div>
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                      ...
                      <button className="self-start sm:self-auto bg-[#9ed0f0] hover:bg-[#83c0e8] active:scale-95 text-gray-800 px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-200 cursor-pointer shadow-sm">
                        Ko'proq Bilish
                      </button>
                    </div>
                  ...
                  <div className="flex items-center gap-8 text-gray-400 text-xs sm:text-sm pt-4 border-t border-gray-100">
              ...
              {/* Skrinshotdagi "Qiziqarlimi ?" havolasi */}
              <div className="mt-6">
                <a 
                  href="#" 
                  className="inline-flex items-center gap-1.5 text-[#80c3ec] hover:text-[#52a6de] font-medium text-sm transition-colors"
                >
                  Qiziqarlimi ? <span className="text-base">→</span>
                </a>
              </div>
